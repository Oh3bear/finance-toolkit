                    ...
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-lg text-xs font-medium border transition-all ${
                        isSelected
                          ...
                          : 'bg-muted/50 border-border text-muted-foreground hover:border-emerald-200'
                      }`}
                    >
    ...
    <Card className="max-w-lg mx-auto">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex justify-between">
          ...
          <Button onClick={executeReconcile} className="gap-1.5 bg-emerald-600 hover:bg-emerald-700">
                ...
                {Object.entries(statusCounts).map(([status, count]) => (
                  <button
                    ...
                    className={`px-2.5 py-1 rounded-lg text-xs font-medium border transition-all ${
                      filterStatus === status
                        ? 'bg-emerald-100 border-emerald-300 text-emerald-700 dark:bg-emerald-900/50 dark:border-emerald-700 dark:text-emerald-300'
                        : 'bg-muted/30 border-border text-muted-foreground hover:border-emerald-200'
                    }`}
                  >
